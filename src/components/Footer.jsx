...
const AppleIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="white" opacity="0.85" aria-label="App Store">
...
const AndroidIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="white" opacity="0.85" aria-label="Google Play">
...
export default function Footer() {
  return (
    <footer style={{ background: '#060C08', color: '#F8FAFC' }}>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-5">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-sm text-center sm:text-left" style={{ color: 'rgba(255,255,255,0.28)' }}>
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-wrap justify-center">
            ...
            <div className="hidden xs:flex items-center gap-1.5 rounded-full px-3 py-1"
              ...
              <span className="text-xs whitespace-nowrap" style={{ color: 'rgba(255,255,255,0.38)' }}>
