    ...
    <div ref={ref} className={`fade-in-section delay-${delay} ${inView ? 'visible' : ''}`}>
      <div
        ...
        onMouseEnter={e => {
          ...
          e.currentTarget.style.boxShadow = '0 8px 48px rgba(0,0,0,0.35), 0 0 24px rgba(16,185,129,0.06)'
      ...
      >
        ...
        <div className="flex items-center gap-3.5 pt-5"
          ...
          <div
            ...
            style={{ background: 'rgba(255,255,255,0.05)', border: '1.5px solid rgba(16,185,129,0.25)' }}
          >
            {review.avatar}
          </div>
          <div>
    ...
    >
      {[
        ...
        <div key={i} className="rounded-2xl p-5"
          ...
          <div className="text-2xl font-black mb-0.5" style={{ color: '#10B981' }}>{stat.value}</div>
...
export default function Reviews() {
  ...
  return (
    <section id="reviews" className="relative py-24 sm:py-32 overflow-hidden" style={{ background: '#0D1A12' }}>
      <div className="absolute bottom-0 left-0 w-[400px] h-[250px] pointer-events-none"
        style={{ background: 'radial-gradient(ellipse at 0% 100%, rgba(16,185,129,0.05) 0%, transparent 65%)' }}
        aria-hidden="true" />
